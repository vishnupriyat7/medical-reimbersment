...
<body>
    ...
    <div class="container-fluid">
        <div class="container">
            ...
            createHeader('shopping-bag', 'Invoice Report', 'Generate EInvoice Report');
            ?>
            <!-- header section end -->
            ...
            <div class="row">
                ...
                <div class="col-md-12 form-group form-inline">
                    <label class="font-weight-bold" for="">Application Number :&emsp;</label>
                    <input type="text" class="form-control" id="by_name" placeholder="Application No." onkeyup="searchMedicine(this.value, 'name');">
